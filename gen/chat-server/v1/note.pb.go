...
const file_note_proto_rawDesc = "" +
	...
	"\vSendMessage\x12\x1a.noteV1.SendMessageRequest\x1a\x16.google.protobuf.EmptyBMZKgithub.com/olezhek28/microservices_course_boilerplate/gen/chat-server/v1;v1b\x06proto3"
...
var file_note_proto_depIdxs = []int32{
	...
	0, // 1: noteV1.ChatServer.Create:input_type -> noteV1.CreateRequest
	2, // 2: noteV1.ChatServer.Delete:input_type -> noteV1.DeleteRequest
	3, // 3: noteV1.ChatServer.SendMessage:input_type -> noteV1.SendMessageRequest
	1, // 4: noteV1.ChatServer.Create:output_type -> noteV1.CreateResponse
	5, // 5: noteV1.ChatServer.Delete:output_type -> google.protobuf.Empty
	5, // 6: noteV1.ChatServer.SendMessage:output_type -> google.protobuf.Empty
